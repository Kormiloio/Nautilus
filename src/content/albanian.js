...
const definitions = [
  ...
  ['aboutme', 'About Me', 'Simple sentences about yourself', [['Unë quhem Mia.','My name is Mia.'],['Jam trembëdhjetë vjeç.','I am thirteen years old.'],['Jetoj në Amerikë.','I live in America.'],['Më pëlqen muzika.','I like music.'],['Po mësoj shqip.','I am learning Albanian.']]],
...
const dialogues = {
  greetings: { roles:['Learner','Friend'], lines:[['Learner','Përshëndetje! Si quhesh?','Hello! What is your name?'],['Friend','Unë quhem Arta. Po ti?','My name is Arta. And you?'],['Learner','Unë quhem Mia. Gëzohem që të njoh.','My name is Mia. Nice to meet you.'],['Friend','Edhe unë. Mirupafshim!','Me too. Goodbye!']] },
