...
values
  ...
  ('00000000-0000-0000-0000-000000000000', '10000000-0000-0000-0000-000000000004', 'authenticated', 'authenticated', 'mia@example.com', '', now(), '{"provider":"google","providers":["google"]}', '{"full_name":"Mia"}', now(), now());
...
values (:'family_a', 'Mia', auth.uid()) returning id as mia_profile \gset
