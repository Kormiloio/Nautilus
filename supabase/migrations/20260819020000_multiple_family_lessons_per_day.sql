-- Families may complete multiple voyage lessons on one calendar date. Voyage
-- progress counts lessons; streaks and active-day visuals still deduplicate
-- the recorded local dates in the application.

drop index if exists public.one_completed_family_day_per_date;
create index family_completed_sessions_by_date
...
begin
  ...
  select lp.id into learner_profile from public.family_voyage_participants p
