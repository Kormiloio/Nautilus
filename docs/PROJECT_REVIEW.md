...
The actual app is substantially larger and more prescriptive than the prior summary. It contains 34 scheduled topics plus one alphabet bonus, a 12-month August–July journey, one-week date-based unlocks, named profiles for Mia, Jake, Mario, and Kristina, family sessions, mixed review, seven badges, stars, streaks, browser text-to-speech, temporary microphone recording, and seven role-play topics.
